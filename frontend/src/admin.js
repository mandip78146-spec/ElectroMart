                                        ...
                                        d.map((a) =>
                                            <div id="users" className="card py-2 " style={{ width: "250px" }}>    
                                                ...
                                                <div className=""><select className="form-select m-auto" onChange={(e) => setadmins(e.target.value)}>
                                                    ...
                                                    <button className="btn btn-primary mt-4 mb-4 " onClick={() => admin(a._id)}>Change </button></div>
                                                    <div>
                                                        ...
                                                        <button className="btn btn-primary mt-4 mb-4 " onClick={() => changeStatus(a._id)}>Change </button>
                                                    </div>
                                                    </div>
                                                </div>
                                        )
